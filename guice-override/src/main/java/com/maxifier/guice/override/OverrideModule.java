package com.maxifier.guice.override;
...
public abstract class OverrideModule extends AbstractModule {
    ...
    public static class OverrideBinder implements Binder {
        ...
        private RecordingOverrideBinder standard = new RecordingOverrideBinder(Stage.TOOL);
        private RecordingOverrideBinder override = new RecordingOverrideBinder(Stage.TOOL);
        ...
        public void install(Module module) {
            standard = standard.skipSources(getClass(), OverrideModule.class);
            if (module instanceof PrivateModule) {
                standard.install(module);
            } else {
                override = override.skipSources(getClass(),OverrideModule.class);
                standard.updateModuleSource(module);
                override.updateModuleSource(module);
                module.configure(this);
                standard.install(ProviderMethodsModule.forModule(module));
                override.undoModuleSource(module);
                standard.undoModuleSource(module);
            }
        }
        ...
        public void bindListener(Matcher<? super Binding<?>> bindingMatcher, ProvisionListener... listeners) {
            standard.bindListener(bindingMatcher,  listeners);
        }
        ...
        public void requireAtInjectOnConstructors() {
            standard.requireAtInjectOnConstructors();
        }

        @Override
        public void requireExactBindingAnnotations() {
            standard.requireExactBindingAnnotations();
        }
