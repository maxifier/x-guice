...
public class FilesPropertyProviderTest {
    ...
    public void testFile(String environment, String client, Map<String, String> expectedValues) throws IOException {
        ...
        new FilesPropertyProvider(properties, CONF_DIR, ArrayListMultimap.create()).
    ...
    public void testRegistry() throws Exception {
        ...
        FilesPropertyProvider registry = new FilesPropertyProvider(
        ...
        String environment = registry.get("environment", "local");
        String client = registry.get("client", registry.get("import"));
